...
class Button():
    def __init__(button_self,screen, x, y, name): # x and y is for rect cordinate not position
        button_self.image = pygame.image.load(f"/Users/datvu/Documents/Project_Nostalgia/Tetris/Graphic/{name}.png")
        ...
        button_self.press_sound = pygame.mixer.Sound(f"/Users/datvu/Documents/Project_Nostalgia/Tetris/Sound/{name}.wav")
