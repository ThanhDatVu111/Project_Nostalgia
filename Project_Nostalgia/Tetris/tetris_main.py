...
def get_font(size): # Returns Press-Start-2P in the desired size
    return pygame.font.Font("Tetris/Graphic/font.ttf", size)
...
# Load the image
image_side = pygame.image.load('Tetris/Graphic/tetris_bg.png')
new_size = (370, 220)  #Adjust the size
game_over_image = pygame.image.load('Tetris/Graphic/over.png')
...
#set up music 
pygame.mixer.music.load("Tetris/Sound/bg_music.mp3")
