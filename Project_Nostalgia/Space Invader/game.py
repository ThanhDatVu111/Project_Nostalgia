...
class Game:
    def __init__(game_self, SCREEN_WIDTH, SCREEN_HEIGHT, OFFSET, game_clock): #automatically executed when an instance of that class is created
        ...
        game_self.run = True
        game_self.game_over_img = pygame.image.load("Space Invader/Graphic/game_over.png").convert_alpha()
        ...
        game_self.explosion_sound = pygame.mixer.Sound("Space Invader/Sound/explosion.ogg")
        game_self.hit_sound = pygame.mixer.Sound("Space Invader/Sound/hit.wav")
        game_self.mshit_sound = pygame.mixer.Sound("Space Invader/Sound/ms.wav")
