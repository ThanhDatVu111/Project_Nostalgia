...
font = pygame.font.Font("Space Invader/Graphic/font.ttf", 20)
...
bg = pygame.image.load("Space Invader/Graphic/space_bg.png")
...
pygame.mixer.music.load("Space Invader/Sound/bg.mp3")
...
while True:
    ...
    x = 50
    spaceship_life = pygame.image.load("Space Invader/Graphic/spaceship_life.png").convert_alpha()
