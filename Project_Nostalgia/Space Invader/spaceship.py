...
class Spaceship(pygame.sprite.Sprite):
    def __init__(ship_self, SCREEN_WIDTH, SCREEN_HEIGHT, OFFSET):
        ...
        original_image = pygame.image.load("Space Invader/Graphic/ship_trans.png").convert_alpha()
        ...
        ship_self.shoot_sound = pygame.mixer.Sound("Space Invader/Sound/laser.ogg")
