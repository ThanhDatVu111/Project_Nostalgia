...
game_background = pygame.image.load("Flappy Bird/Graphic/flappy_bg.png")
ground_image = pygame.image.load("Flappy Bird/Graphic/ground1.png")
restart_image = pygame.image.load("Flappy Bird/Graphic/restart.png")
start_image = pygame.image.load("Flappy Bird/Graphic/start.png")
exit_image = pygame.image.load("Flappy Bird/Graphic/exit.png")
...
font = pygame.font.Font("Flappy Bird/Graphic/font.ttf", 40)
white = (255, 255, 255)
...
# Load the sound
jump_sound = pygame.mixer.Sound("Flappy Bird/Sound/flap.mp3") 
point_sound = pygame.mixer.Sound("Flappy Bird/Sound/point.mp3") 
die_sound = pygame.mixer.Sound("Flappy Bird/Sound/die.mp3") 
hit_sound = pygame.mixer.Sound("Flappy Bird/Sound/hit.mp3") 
...
class Bird(pygame.sprite.Sprite): #pygame.sprite.Sprite is a base class for creating sprite objects
    def __init__(bird,x,y):
        ...
        bird.counter = 0
        for i in range(1,4):
            image = pygame.image.load(f"Flappy Bird/Graphic/bird{i}.png")
...
class Pipe(pygame.sprite.Sprite): #pygame.sprite.Sprite is a base class for creating sprite objects
    def __init__(pipe, x, y, position):
        ...
        pipe.image = pygame.image.load("Flappy Bird/Graphic/pipe.png") #load pipe picture
...
pygame.mixer.music.load("Flappy Bird/Sound/Underwater Theme.mp3")
...
while run_time:
    ...
    if game_over == True:
        ...
        if exit_button.draw_and_pressed() == True:
            Popen(["python3", "Game Menu/nostalgia_menu.py"])
