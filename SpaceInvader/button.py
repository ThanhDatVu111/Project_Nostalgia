...
class Button():
    def __init__(button_self, x, y, name): # x and y is for rect cordinate not position
        button_self.image = pygame.image.load(f"/Users/datvu/Desktop/Project/Project_Nostalgia/SpaceInvader/Graphic/{name}.png")
        ...
        button_self.press_sound = pygame.mixer.Sound(f"/Users/datvu/Desktop/Project/Project_Nostalgia/SpaceInvader/Sound/{name}.wav")
